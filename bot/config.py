...
class Settings(BaseSettings):
    ...
    # URL Local Bot API (контейнер bot-api). Для стандартного облака оставить дефолт.
    # Local Bot API снимает лимит на загрузку/отправку до 2 ГБ.
