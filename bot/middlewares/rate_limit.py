"""Rate limiting — ограничение частоты запросов на обработку PDF
...
# лимит — сколько обработок в минуту
MAX_REQUESTS = 5
WINDOW_SECONDS = 60
...
class RateLimitMiddleware(BaseMiddleware):
    """Ограничивает частоту обработки — только для document-сообщений (PDF файлы)"""
    ...
    async def __call__(
        ...
        # ограничиваем только сообщения с документами (PDF файлы)
